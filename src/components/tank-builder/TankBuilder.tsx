  ...
  return (
    <main className="min-h-screen pt-24 pb-20 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        {/* View toggle: Compatibility vs Water */}
        <div className="inline-flex rounded-xl bg-white/5 border border-white/10 p-1 mb-6">
          <button
          ...
          hasStock ? (
            ...
            <div className="rounded-2xl bg-white/5 border border-white/10 p-10 text-center">
              ...
              <p className="text-white font-medium mb-1">
                Add fish to see compatibility
              </p>
              <p className="text-ocean-400 text-sm">
                Search above to add a species, and the compatibility, stocking,
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl bg-white/5 border border-white/10 p-5">
              ...
              <p className="text-ocean-400 text-xs mb-4 leading-relaxed">
                Enter whatever you have from your test kit — you don&apos;t need
                to fill in every box. Leave the rest blank.
              </p>
              ...
              {!hasStock && (
                <p className="text-[11px] text-ocean-500 mt-4 leading-relaxed">
                  Add fish in the tank above and the pH and temperature checks
                  will also tell you how well your water suits them.
                </p>
              )}
            </div>
            ...
            {waterResult.status === "empty" ? (
              <div className="rounded-2xl bg-white/5 border border-white/10 p-10 text-center">
                ...
                <p className="text-ocean-400 text-sm">
                  Fill in at least one value above and you&apos;ll get a
                  plain-English read on what&apos;s happening and how to fix it.
                </p>
              </div>
