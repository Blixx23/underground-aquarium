...
export default function CTA() {
  return (
    <section className="relative py-28 overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] max-w-full h-[400px] bg-ocean-500/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center">
        ...
        <h2 className="font-display text-4xl md:text-6xl text-white glow-text mb-6">
          ...
          <br />
          <span className="text-ocean-300">somebody wants</span>
        </h2>

        <p className="text-ocean-300/80 text-xl max-w-2xl mx-auto leading-relaxed mb-12">
          The fry you can&apos;t house. The stems you trim every week. The tank
          in the garage. Put it up, and let someone twenty minutes away come get
          it.
        </p>
        ...
        <p className="mt-10 text-xs font-mono text-ocean-600 tracking-wider">
          No listing fee · No commission · No card, ever
        </p>
      </div>
    </section>
  );
